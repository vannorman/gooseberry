...
def render_md_blog(request):
    with open('gooseberry/templates/blog/redefinelearning.md', 'rb') as fp:
        v = fp.read()
        v = md.convert(v)
        obj = {}
        obj['html_text'] = v
...
#	obj['social'] = [
#		{ "name" : "github.com/gooseberry", "link" : "https://github.com/gooseberry" },
#		{ "name" : "linkedin.com/in/gooseberry", "link" : "https://www.linkedin.com/in/gooseberry" },
#		{ "name" : "facebook.com/gooseberry", "link" : "https://www.facebook.com/gooseberry" },
#		{ "name" : "twitter.com/@gooseberry", "link" : "https://twitter.com/@gooseberry" },
#		{ "name" : "angel.co/supermathworld", "link" : "https://angel.co/supermathworld" },
#		{ "name" : "soundcloud.com/gooseberry", "link" : "https://soundcloud.com/gooseberry" },
#	]
